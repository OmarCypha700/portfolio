...
//             target="_blank"
//             className="inline-flex items-center gap-2 rounded-full bg-gray-900 dark:bg-white/10 px-6 py-3 text-sm font-medium text-white dark:text-gray-200 hover:bg-gray-800 dark:hover:bg-white/20 transition-colors"
//           >
...
//             target="_blank"
//             className="inline-flex items-center gap-2 rounded-full border border-gray-300 dark:border-white/10 px-6 py-3 text-sm font-medium hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"
//           >
...
//         className="relative mb-12 h-64 w-full overflow-hidden rounded-2xl border border-gray-200 dark:border-white/10 shadow-xl sm:h-80 md:h-96"
//       >
//         <Image
//           src={project.image}
//           alt={project.title}
...
//               <div className="relative w-full overflow-hidden rounded-2xl border border-gray-200 dark:border-white/10 shadow-lg" style={{ paddingBottom: "56.25%" }}>
//                 <iframe
...
//               {/* Main Image */}
//               <div className="relative mb-4 h-80 w-full overflow-hidden rounded-2xl border border-gray-200 dark:border-white/10 shadow-lg">
//                 <Image
...
//                   <span
//                     key={tech}
//                     className="rounded-full bg-gray-100 dark:bg-white/10 px-4 py-2 text-sm font-medium"
//                   >
//                     {tech}
//                   </span>
//                 ))}
...
//             {/* Project Links */}
//             <section className="rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 p-6">
